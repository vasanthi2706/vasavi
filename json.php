<?php
  ...
  LEFT JOIN tbl_hf ON tbl_hf.pname = tbl_price.pname
  LEFT JOIN tbl_ammenties ON tbl_ammenties.pname = tbl_hf.pname
  LEFT JOIN tb_af ON tb_af.pname = tbl_ammenties.pname
  LEFT JOIN tbl_hc ON tbl_hc.pname = tb_af.pname";
/*$sql="SELECT *
  FROM tbl_property
