...
<script type="text/javascript">
 ...
 where tbl_property.p_name='$pname' and 
  ...
  $result=mysqli_query($mysqli,$sql)or die(mysqli_error($mysqli));
   ...
   {
    $categories = array("1BHK", "2BHK", "3BHK", "4BHK","4BHK+");
    $categories2 = array("3BHK", "4BHK","5BHK","5BHK+");

 $dbcategory=explode(',',$row['p_category1']);
   ...
   if(in_array($category,$dbcategory)) {
     
    echo "<input name=\"category[]\" type=\"checkbox\" value=\"$category\" CHECKED> $category ";

      } else

      {

    echo "<input name=\"category[]\" type=\"checkbox\" value=\"$category\"> $category";
